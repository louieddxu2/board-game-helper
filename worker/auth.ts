...
export const isPublicReadRequest = (method: string, requestUrl: string): boolean => {
  ...
  return ['/api/health', '/api/home', '/api/search', '/api/tags', '/api/tags/changes', '/api/game-catalog', '/api/game-catalog/changes', '/api/games/search', '/api/games/resolve', '/api/export/public'].includes(path)
    || isPublicGameDetail;
};
