...
export const isPublicReadRequest = (method: string, requestUrl: string): boolean => {
  ...
  return ['/api/health', '/api/home', '/api/search', '/api/tags', '/api/tags/changes', '/api/game-catalog', '/api/game-catalog/changes', '/api/attributes/vote-subjects', '/api/attributes/table', '/api/attributes/table/changes', '/api/games/search', '/api/games/resolve'].includes(path)
    || isPublicGameDetail;
};
