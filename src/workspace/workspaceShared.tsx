...
export type TableReorderSession = TableReorderVisual & { pointerId: number; startX: number; startY: number; active: boolean; dragIntentConfirmed?: boolean; timer?: number };
