...
const WorkspacePage = () => {
  ...
  const beginDrawerSwipe = useCallback((event: React.PointerEvent<HTMLElement>) => {
    ...
    if (drawerItemDraggingRef.current) return;
  ...
  const handleDrawerItemDragStateChange = useCallback((active: boolean) => {
