...
const WorkspacePage = () => {
  ...
  return <section className="workspace-page">
    <header className="workspace-header"><div className="workspace-title-group"><button type="button" className="workspace-menu-button" aria-label="開啟目錄" onClick={() => setDrawerOpen((current) => !current)}>☰</button><div><p className="eyebrow">LOCAL WORKSPACE</p><h1>動態表格</h1></div></div><div className="workspace-header-actions"><button type="button" className="button secondary" onClick={addTable.bind(null, null)}>＋表格</button><button type="button" className="button secondary" onClick={() => addFolder(null)}>＋資料夾</button></div></header>
